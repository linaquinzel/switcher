...
def draw_rectangle_aroud_cards(switchers_coordinates, image):
    ...
    cv2.waitKey(0)
contour, image__ = find_contours_of_switchers("box4.jpg")
coordinates = find_coordinates_of_switchers(contour, image__)
draw_rectangle_aroud_cards(coordinates, image__)